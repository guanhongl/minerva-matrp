...
const About = () => (
  <Grid id={PAGE_IDS.ABOUT_US} verticalAlign='middle' textAlign='center' container centered style={{ minHeight: "calc(100vh - 230px)" }}>
    <Grid.Column width={12}>
      <Image src='../images/minervaLogoBlack.png' size='medium' centered/>
      <Header as='h1' icon textAlign='center'>
        <Header.Content>About Us</Header.Content>
      </Header>
      <p style={{ letterSpacing: '0.5px' }}>Minerva Medical is a project for ICS 414 at UH Manoa, the project page can be seen
